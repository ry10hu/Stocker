...
class MainMenuTab(tk.Frame):
    def __init__(self, parent, notebook=None):
        ...
        self.MainMenuPanedWindow.place(
            relx=0.017, rely=0.024, relheight=0.952, relwidth=0.957
        )

        self.MainMenuPanedWindow_p1 = ttk.Labelframe(
            self.MainMenuPanedWindow, width=165, text="Pane 1"
        )
        self.MainMenuPanedWindow.add(self.MainMenuPanedWindow_p1, weight=0)
        self.MainMenuPanedWindow_p1.configure(text="Pane 1")

        self.MainMenuPanedWindow_p2 = ttk.Labelframe(
            self.MainMenuPanedWindow, text="Pane 2"
        )
        ...
        self.AssetTabButton.place(
            relx=0.075, rely=0.126, height=59, width=147, bordermode="ignore"
        )
        ...
        self.SaveButton = tk.Button(self.MainMenuPanedWindow_p2)
        self.SaveButton.place(
            relx=0.075, rely=0.3, height=59, width=147, bordermode="ignore"
        )
        self.SaveButton.configure(activebackground="#d9d9d9")
        self.SaveButton.configure(text="Save")
        self.SaveButton.configure(command=lambda: commands.files.save("1"))

        self.InventoryButton = tk.Button(self.MainMenuPanedWindow_p2)
        self.InventoryButton.place(
            relx=0.075, rely=0.6, height=59, width=147, bordermode="ignore"
        )
        self.InventoryButton.configure(activebackground="#d9d9d9")
        self.InventoryButton.configure(text="Inventory")
        self.InventoryButton.configure(command=commands.miscellaneous.inventory)

        self.AboutText = tk.Text(self.MainMenuPanedWindow_p1)
        self.AboutText.place(
